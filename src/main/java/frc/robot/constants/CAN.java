...
public final class CAN {
  ...
  public static final int frontLeftDriveMotor = 20; // frontLeft
  public static final int frontLeftTurnMotor = 21;
  public static final int frontRightDriveMotor = 22; // frontright
  public static final int frontRightTurnMotor = 23;
  public static final int backLeftDriveMotor = 24; // backLeft
  public static final int backLeftTurnMotor = 25;
  public static final int backRightDriveMotor = 26; // backRight
